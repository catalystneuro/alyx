    ...
    return Response(
        {
            ...
            "datarepository-url": reverse(
                "datarepository-list", request=request, format=format
            ),
            "datarepositorytype-url": reverse(
                "datarepositorytype-list", request=request, format=format
            ),
            "dataformat-url": reverse(
                "dataformat-list", request=request, format=format
            ),
            "dataset-types-url": reverse(
                "datasettype-list", request=request, format=format
            ),
