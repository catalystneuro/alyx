...
weights_sql = sprintf(['select weight_date, weight, food_type, unit, amount '  ...
'from (' ...
...
'and ssubj.nickname = ''%s'' ' ...
'order by weight_date asc'], subject_nickname)


weights = fetch(conn, weights_sql);